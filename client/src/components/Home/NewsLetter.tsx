      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
          ...
          <button 
            ...
            type="submit"
            className="px-8 py-3.5 bg-app-dark text-white font-semibold rounded-xl hover:bg-app-dark-hover transition-colors shadow-sm whitespace-nowrap active:scale-[0.98]"
          >
            Subscribe
          </button>
        </form>
