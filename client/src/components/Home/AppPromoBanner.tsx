...
function AppPromoBanner() {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 my-14 bg-app-dark-pure rounded-2xl">
        
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 xl:px-10">
        {/* Left side content */}
        <div className="text-center md:text-left">
          <h2 className="font-serif text-3xl sm:text-4xl text-orange-300 mb-3">
